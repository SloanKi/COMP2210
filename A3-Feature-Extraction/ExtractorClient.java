...
public class ExtractorClient {
   ...
   public static void main(String[] args) {
      ...
      /*Extractor cl2 = new Extractor("filename.txt");
      SortedSet<Line> bruteLines2 = cl2.getLinesBrute();
      System.out.println("Brute: ");
      printLines(bruteLines2);
   
      SortedSet<Line> fastLines2 = cl2.getLinesFast();
      System.out.println("Fast: ");
      printLines(fastLines2);*/ 
   }
